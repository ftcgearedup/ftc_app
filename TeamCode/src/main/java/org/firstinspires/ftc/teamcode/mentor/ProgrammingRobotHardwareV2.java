 ...
 */
public class ProgrammingRobotHardwareV2 {
    ...
    private ProgrammingRobotHardwareV2(){}

    public static ProgrammingRobotHardwareV2 getInstance() {
    ...
    public OpticalDistanceSensor getFrontLightSensor() {
        ...
        private static class LazyHolder {
            private static final ProgrammingRobotHardwareV2 INSTANCE = new ProgrammingRobotHardwareV2();
        }
}
