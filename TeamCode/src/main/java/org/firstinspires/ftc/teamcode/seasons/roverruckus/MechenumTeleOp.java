...
//works with X pattern mecanum wheel configuration, when in 'circle' pattern, strafing is reversed
//NOTE: circle pattern is not prefered because the robot can be turned without the wheels moving.
...
//        hook = hardwareMap.dcMotor.get("hook");
        ...
        // set wheel direction
        frontLeft.setDirection(DcMotorSimple.Direction.REVERSE);  //originally forward
        backLeft.setDirection(DcMotorSimple.Direction.FORWARD);  //originally reverse
        frontRight.setDirection(DcMotorSimple.Direction.FORWARD);  //originally reverse
        backRight.setDirection(DcMotorSimple.Direction.REVERSE);  //originally forward
